...
## [0.9.0-mil.0] — UNRELEASED — DRAFT (gated on Gate A: 1-week LinkedIn Strategist pilot of `post_issue_interaction`, started 2026-05-02 ~21:25 UTC; do not merge before pilot passes the four-criterion verification in `paperclip/scripts/check-pilot.mjs`)
